...
public class SmartbearSoftwareOrderPlacing {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        orderLink.click();
        WebElement order = driver.findElement(By.xpath("//*[@id='ctl00_MainContent_fmwOrder_ddlProduct']"));
        Select product = new Select(order);
        product.selectByVisibleText("Family Album");
        driver.findElement(By.xpath("//*[@id='ctl00_MainContent_fmwOrder_txtQuantity']")).sendKeys(Keys.BACK_SPACE);
        Thread.sleep(5000);
        driver.findElement(By.xpath("//*[@id='ctl00_MainContent_fmwOrder_txtQuantity']")).sendKeys("2");
        ...
        inputZip.sendKeys(faker.address().zipCode());
    }*/
